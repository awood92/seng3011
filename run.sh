...
cat ../sample/1-march-2013-data.csv | ./trader_cli.py -e "Initial Engine" -s "Initial Strategy Evaluator" -g "Momentum Signal Generator" && python -m SimpleHTTPServer & xdg-open http://127.0.0.1:8000/
failure=$?
cd ..
